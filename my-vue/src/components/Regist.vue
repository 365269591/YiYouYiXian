...
<style scoped>
	...
	.regist p span{
		display: inline-block;height:1rem;width: 1.2rem;text-align: right;margin-right: 0.2rem;float: left;
	}
	.regist p input{
		height: 1rem;float: left;
	}
	.regist p i{
		color: red;display: inline-block;height: 1rem;float: left;display: none;
	}
	input{
		border: none;
	}
